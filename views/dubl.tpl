...
<meta charset="UTF-8" />
<title>RGD DublMatch {{title}}</title>
...
<h1>RGD {{title}}</h1>
<h3>
<!--  <a href="/listSkillnad/families">Byt till familj</a>
...
<form action="/listDubl" method="get">
<input type="hidden" name="pageNo" value="{{page}}"/>
<div align="center">
Sorting by nodeSim: <input type="checkbox" name="sortNS"
			   {{sort}} onclick="this.form.submit()" />
&nbsp; | | &nbsp; &nbsp; | | &nbsp; &nbsp; | | &nbsp; &nbsp;
<!--
Prev:<input type="checkbox" name="page" value="prev"
	      onclick="this.form.submit()" />;
&nbsp; | | &nbsp; &nbsp; | | &nbsp; &nbsp; | | &nbsp; 
Next:<input type="checkbox" name="page" value="next"
	      onclick="this.form.submit()" />;
-->
