...
##AA0 Nya program för att generera sou2.dat
os.system('php ../../../PHP/konvktxtz.php >> Log')
os.system('php ../../../PHP/komprgdsz.php >> Log')
os.system('php ../../../PHP/uppdrgdmz.php >> Log')
#use sou2.dat instead of sour.dat
os.system('mv sour.dat sour.dat.ORG')
os.system('mv sou2.dat sour.dat')
###
...
if os.path.isfile('./Note.txt'):
    print '<b><a href="/getFile?fil='+rootdir+'/Note.txt" target="_blank">Note.txt</a> - </b>Noteringar<br>'
...
#Remove temporary workfiles but keep RGD9
